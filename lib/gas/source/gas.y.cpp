...
#define yyparse         gsparse
#define yylex           gslex
#define yyerror         gserror
#define yydebug         gsdebug
#define yynerrs         gsnerrs


/* Copy the first part of user declarations.  */

#line 74 "gas.y.cpp" /* yacc.c:339  */
...
#line 155 "gas.y.cpp" /* yacc.c:355  */

#endif /* !YY_GS_GAS_Y_HPP_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 161 "gas.y.cpp" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 41 "gas.y" /* yacc.c:359  */


    extern int gslex (YYSTYPE * yylval_param, void * yyscanner);


#line 169 "gas.y.cpp" /* yacc.c:359  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined GSSTYPE_IS_TRIVIAL && GSSTYPE_IS_TRIVIAL)))
...
{
       0,   256,   257,   258,   259,    91,    93,   123,   125,    58,
      44,    61,    59
};
# endif
...
{
       1,    -9,     6,    11,    -9,    -9,     1,    -9,    -9,     6,
       8,    -8,     7,    -1,    -9,    -9,    -9,    -7,     6,    12,
      10,     6,     6,    12,    -9,    -9,    15,     2,     1,    13,
      16,     9,    -9,    -9,    14,     6,     6,    -9,    -9,    17,
      18,     6,     6,    -9,    20,     6,    -9
};
...
{
       7,    20,     0,     0,    12,     2,     8,     9,    11,     0,
      21,     0,     0,     4,     1,    10,    21,     0,     0,    18,
       0,     0,     0,    18,    22,    16,    19,     0,     7,     0,
       0,     0,    17,    13,     0,     0,     0,    14,     3,     0,
       0,     0,     0,     5,     0,     0,     6
};
...
{
      13,    18,    18,    19,    23,     1,     2,    16,    21,    22,
       1,    14,   -15,    20,    33,    25,    24,    28,    32,    29,
      30,    37,    38,    35,    34,    36,    41,    15,    42,    45,
       0,    17,     0,    39,    40,     0,     0,     0,     0,    43,
      44,     0,    31,    46
};

static const yytype_int8 yycheck[] =
{
       2,     9,     9,    11,    11,     4,     5,     9,     9,    10,
       4,     0,     4,     6,    12,     3,    18,     7,     3,    21,
      22,    12,     8,    10,    28,     9,     9,     6,    10,     9,
...
static const yytype_uint8 yystos[] =
{
      ...
      24,    25,    16,    24,     0,    19,    24,    25,     9,    11,
       6,     9,    10,    11,    24,     3,    22,    23,     7,    24,
      24,    23,     3,    12,    17,    10,     9,    12,     8,    24,
      24,     9,    10,    24,    24,     9,    24
};
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (scanner, node, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
...
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, void * scanner, siege::Node * node)
{
  ...
  yy_symbol_value_print (yyoutput, yytype, yyvaluep, scanner, node);
  YYFPRINTF (yyoutput, ")");
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, scanner, node); \
} while (0)
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 69 "gas.y" /* yacc.c:1646  */
    { node = node->parent(); }
#line 1275 "gas.y.cpp" /* yacc.c:1646  */
    break;

  case 4:
#line 73 "gas.y" /* yacc.c:1646  */
    { node = node->appendChild((yyvsp[0])); }
#line 1281 "gas.y.cpp" /* yacc.c:1646  */
    break;

  case 5:
#line 74 "gas.y" /* yacc.c:1646  */
    { node = node->appendChild((yyvsp[0]), (yyvsp[-4])); }
#line 1287 "gas.y.cpp" /* yacc.c:1646  */
    break;

  case 6:
#line 75 "gas.y" /* yacc.c:1646  */
    {
...
#line 1298 "gas.y.cpp" /* yacc.c:1646  */
    break;

  case 13:
#line 99 "gas.y" /* yacc.c:1646  */
    { node->appendValue((yyvsp[-3]), (yyvsp[-1])); }
#line 1304 "gas.y.cpp" /* yacc.c:1646  */
    break;
...
#line 127 "gas.y" /* yacc.c:1646  */
    {
        ...
        (yyval).erase(0, (yyval).find_first_not_of(" \n\r\t"));
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (scanner, node, YY_("syntax error"));
#else
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, scanner, node);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (scanner, node, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, scanner, node);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
